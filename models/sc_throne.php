...
//print_r( '$url: ' . $url . "\n");
			...
			if( $p == 1 ){
				$post_tag = $site['IllegalSite']['sc_post_tag'];
			} else {
				$post_tag = $site['IllegalSite']['sc_post_tag_forSearchResult'];
			}
			$html = &$crlSite->get_html( $url, $site, $post_tag, false );	// スクレイピング
