...
//	$html->meta('icon', '/img/favicon.ico');
	...
	AppController::set('title_for_layout', 'モノミインフォ - 利用規約');
...
<br />
第3条（入会）<br />
（1）物見インフォの利用希望者は、本則を承認した上で、 物見インフォのサイト上にある申込ページの手続に従って利用を申込むものとし、当該手続が完了した時点で該当する物見インフォの利用契約が成立して利用資格を得、会員となるものとします。<br />
...
過去に、物見インフォの利用に際し、料金の未納、滞納をした場合<br />
