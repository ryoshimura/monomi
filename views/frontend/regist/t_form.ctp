<?php
	$html->css(array('common', 'regist_form_test') , null, array('inline'=>false));
	$html->script(array('jquery/jquery-1.4.2.min','frontend/regist_t'), array('inline'=>false));
...
<div class="inner">
		...
		<p class="intro">
			初めて物見インフォ有料版をお申込みいただくお客様向けの申込フォームです。<br />
