...
<div class="work_right">
	<div class="status">
		<p>
			<span>巡回監視中</span>
			<?php echo date( 'Y/m/d', strtotime( $license[1]['License']['start_date'] )); ?>に停止します
		</p>
	</div>
	<div class="link"><a class="corner" href="/watchconfs/?mode=continue&id=<?php echo $rc['Work']['work_uid']; ?>">次の更新日以降も監視する</a></div>
</div>