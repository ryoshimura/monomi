...
?>
					<p>残り　：　<span class="st_num"><?php echo $view['remaining']; ?></span>日（ <?php echo date( 'Y年m月d日', strtotime($view[1]['License']['end_date']) + 86400 ); ?></>に<?php echo $view[2]['Plan']['fixed_term']; ?>日間の自動更新を行ないます ）</p>
...
?>
			...
			<div id="linkmenu_right">
				...
				<p><a class="corner" href="/accounts/cancel/">自動更新しない（解約）</a></span></p>
			</div>
